...
from .models import db_connect, create_table, User, Tag, Question, Answer, QuestionComment, AnswerComment
            ...
            if cmt['comment_content'] == ' ':
                ...
                if exist_cmt is not None:
                    ...
                    comment = QuestionComment(stack_question_comment_id=cmt['stack_question_comment_id'],
                                              comment_content=cmt['comment_content'], user_id=cmt['user_id'],
